...
Quiz(
  ...
  [
    ...
    M("Quelles zones mémoire sont concernées par la gestion automatique du garbage collector en Java ?", ["Le tas (heap)"], ["La pile d'appels (call stack) pour les variables locales primitives", "Le disque dur"]),
