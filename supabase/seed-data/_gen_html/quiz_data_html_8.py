    ...
    quizzes.append(quiz(
        ...
        [
            ...
            M("Quelles affirmations sur <template> sont correctes ?",
              ["Son contenu est accessible via JavaScript sans être visible directement", "Il est souvent utilisé pour générer des listes ou cartes répétées dynamiquement"],
              ["Il s'affiche immédiatement comme un <div> classique", "Il interdit tout élément interactif en son sein"]),
