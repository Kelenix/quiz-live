#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assembleur de la banque de quiz Python pour Quiz Live.
Importe quiz_data_a + nouveaux modules (b2, c, d, e), construit la liste finale,
...
MODULES = (quiz_data_a, quiz_data_b2, quiz_data_c, quiz_data_d, quiz_data_e)
for mod in MODULES:
...
# Titres uniques (insensible casse/espaces)
def norm(s):
...
# Statements uniques (insensible casse/espaces), 6 questions/quiz, 3 types presents
stmts_seen = {}
for qi, z in enumerate(QUIZZES):
    qs = z["questions"]
    if len(qs) != 6:
